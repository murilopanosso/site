export default {
  js: 'Javascript is currently the language I am most comfortable with, I have been working with JS since 2013, and since then, I am constantly discovering new features, which sometimes I believe that first arose as a flaw (or something in between). But I love how flexible JS can be, and how powerful when it comes to end user interaction.',
  java: 'Java is my first BE language, since I have faced challenges involving Java in almost every team I had contributed with. Yes, it’s verbose. Yes, it’s pretty damn heavy. Sometimes comply with DDD, for example, could be very painful. But it would probably be my choice for a commercial product, since it’s indisputably reliable, and relatively easy to find developers who master Java.',
